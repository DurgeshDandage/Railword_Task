...
public class HospitalManagementSystem {
    ...
    public static void bookAppointment(Patient patient, Doctor doctor, Connection connection, Scanner scanner) {
        ...
        if (patient.getPatientById(patientId) && doctor.getDoctorById(doctorId)) {
            if (checkDoctorAvailability(doctorId, appointmentDate, appointmentTime, connection)) {
                String appointmentQuery = "INSERT INTO appointments(patient_id, doctor_id, appointment_date, appointment_time, status) VALUES(?, ?, ?, ?, ?)";
                try {
    ...
    public static void checkTablesExist(Connection connection) {
        try {
            ...
            ResultSet rs = dbMetaData.getTables(null, null, "appointments", null);
            if (rs.next()) {
                System.out.println("Table 'appointments' exists.");
            } else {
                System.out.println("Table 'appointments' does NOT exist.");
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
